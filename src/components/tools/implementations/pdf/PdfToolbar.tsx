  ...
  return (
    <div className="flex flex-col shrink-0">
      <header className="h-14 border-b border-slate-200 bg-white px-3 sm:px-4 flex items-center justify-between gap-2 sm:gap-3 shrink-0 select-none">
        ...
        {/* Center: Mode Selector & Page Nav & Zoom */}
        <div className="flex items-center gap-1 sm:gap-2.5">
          {/* High-level Mode Selector */}
          <div className="hidden lg:flex items-center gap-0.5 bg-slate-100 p-0.5 rounded-lg border border-slate-200 mr-1">
            <button
              type="button"
              onClick={() => onModeChange?.("SELECT")}
              className={`px-2 py-1 text-xs rounded-md transition-colors ${
                mode === "SELECT" ? "bg-white text-slate-900 shadow-xs font-semibold" : "text-slate-600 hover:text-slate-900"
              }`}
              data-testid="toolbar-mode-select-btn"
            >
              Select
            </button>
            <button
              ...
              data-testid="toolbar-mode-text-btn"
            >
              Text
            </button>
            <button
              ...
              data-testid="toolbar-mode-fill-sign-btn"
            >
            ...
            <button
              ...
              data-testid="toolbar-mode-annotate-btn"
            >
              Annotate
            </button>
            <button
              ...
              data-testid="toolbar-mode-pages-btn"
            >
              Pages
            </button>
          </div>
            ...
            {exportMenuOpen && (
              <>
                ...
                <div className="absolute right-0 top-full mt-1.5 w-60 rounded-xl border border-slate-200 bg-white p-1.5 shadow-xl z-50 animate-in fade-in duration-100">
                  ...
                  >
                    <CheckIcon className="size-4 text-sky-600 mt-0.5 shrink-0" />
                    <div>
      ...
      {/* Fill & Sign Dedicated Sub-Toolbar */}
      {mode === "FILL_AND_SIGN" && (
        <div
          className="h-10 bg-slate-900 text-white px-3 sm:px-4 flex items-center justify-between gap-2 shadow-xs shrink-0 select-none animate-in fade-in duration-150"
          data-testid="fill-sign-subtoolbar"
        >
          <div className="flex items-center gap-1 sm:gap-1.5">
            <span className="text-xs font-semibold text-sky-400 mr-1 flex items-center gap-1">
            ...
            <Button
              ...
              size="sm"
              variant="ghost"
              onClick={() => onFillAndSignToolChange?.("text")}
              className={`h-7 text-xs gap-1 rounded-md text-slate-200 hover:text-white ${
                fillAndSignTool === "text" ? "bg-sky-600 text-white hover:bg-sky-700 font-semibold" : ""
              }`}
              data-testid="fill-sign-tool-text-btn"
            >
            ...
            <Button
              ...
              size="sm"
              variant="ghost"
              onClick={() => onFillAndSignToolChange?.("check")}
              className={`h-7 text-xs gap-1 rounded-md text-slate-200 hover:text-white ${
                fillAndSignTool === "check" ? "bg-sky-600 text-white hover:bg-sky-700 font-semibold" : ""
              }`}
              data-testid="fill-sign-tool-check-btn"
            >
            ...
            <Button
              ...
              size="sm"
              variant="ghost"
              onClick={() => onFillAndSignToolChange?.("cross")}
              className={`h-7 text-xs gap-1 rounded-md text-slate-200 hover:text-white ${
                fillAndSignTool === "cross" ? "bg-sky-600 text-white hover:bg-sky-700 font-semibold" : ""
              }`}
              data-testid="fill-sign-tool-cross-btn"
            >
              <CrossIcon className="size-3 text-red-400" />
              <span>Cross</span>
            </Button>
            ...
            <Button
              ...
              size="sm"
              variant="ghost"
              onClick={() => onFillAndSignToolChange?.("signature")}
              className={`h-7 text-xs gap-1 rounded-md text-slate-200 hover:text-white ${
                fillAndSignTool === "signature" ? "bg-sky-600 text-white hover:bg-sky-700 font-semibold" : ""
              }`}
              data-testid="fill-sign-tool-signature-btn"
            >
            ...
            <Button
              ...
              size="sm"
              variant="ghost"
              onClick={() => onFillAndSignToolChange?.("draw")}
              className={`h-7 text-xs gap-1 rounded-md text-slate-200 hover:text-white ${
                fillAndSignTool === "draw" ? "bg-sky-600 text-white hover:bg-sky-700 font-semibold" : ""
              }`}
              data-testid="fill-sign-tool-draw-btn"
            >
          ...
          <div className="flex items-center gap-2">
            <span className="text-[11px] text-slate-400 hidden md:inline">
              Click anywhere on page to place or draw
            </span>
            <Button
              type="button"
              size="sm"
              ...
              data-testid="fill-sign-exit-btn"
            >
              <CrossIcon className="size-3 mr-1" />
              <span>Exit</span>
            </Button>
          </div>
        </div>
