...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // DEV-ONLY: No real registration backend exists yet.
    console.warn(
      "[DEV-ONLY] Registration simulated for email:",
      result.data.email,
  ...
  return (
    <div className="relative">
      ...
      >
        Dev-only demo registration — no real authentication
      </Badge>
          ...
          {success ? (
            <div className="flex flex-col items-center gap-4 py-4">
              ...
              <p className="text-center text-sm text-muted-foreground">
                Registration simulated — dev mode only
              </p>
              <Link href="/app/akaunkemas/login">
